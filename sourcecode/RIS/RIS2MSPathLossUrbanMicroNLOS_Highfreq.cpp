...
#include "./RIS2MSPathLossUrbanMicroNLOS_Highfreq.h"
#include "../Parameters/Parameters.h"

using namespace cm;
///构造函数
RIS2MSPathLossUrbanMicroNLOS_ModeB::RIS2MSPathLossUrbanMicroNLOS_ModeB( void ){
}
///析构函数
RIS2MSPathLossUrbanMicroNLOS_ModeB::~RIS2MSPathLossUrbanMicroNLOS_ModeB( void ){
}
///计算DB值
double RIS2MSPathLossUrbanMicroNLOS_ModeB::Db( double _dDisM_3D , double _dUEHeightM){
    if ( cm::P::s().IChannelModel_for_Scenario ==  P::_5GCM_TWO_LAYER ) {
        ...
        assert(Parameters::Instance().MSS.DAntennaHeightM == 1.5);
    }
