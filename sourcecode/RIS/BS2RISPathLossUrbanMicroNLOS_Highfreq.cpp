...
using namespace cm;
///构造函数
BS2RISPathLossUrbanMicroNLOS_ModeB::BS2RISPathLossUrbanMicroNLOS_ModeB( void ){
}
///析构函数
BS2RISPathLossUrbanMicroNLOS_ModeB::~BS2RISPathLossUrbanMicroNLOS_ModeB( void ){
}
///计算DB值
double BS2RISPathLossUrbanMicroNLOS_ModeB::Db( double _dDisM_3D , double _dUEHeightM){
