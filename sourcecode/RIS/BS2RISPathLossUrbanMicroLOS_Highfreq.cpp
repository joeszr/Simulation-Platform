...
using namespace cm;
///构造函数
BS2RISPathLossUrbanMicroLOS_ModeB::BS2RISPathLossUrbanMicroLOS_ModeB( void ){
}
///析构函数
BS2RISPathLossUrbanMicroLOS_ModeB::~BS2RISPathLossUrbanMicroLOS_ModeB( void ){
}
///计算DB值
double BS2RISPathLossUrbanMicroLOS_ModeB::Db( double _dDisM_3D , double _dUEHeightM){
