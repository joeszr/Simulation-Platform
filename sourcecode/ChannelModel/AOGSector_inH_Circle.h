...
namespace cm {
    ...
    /// @brief 120度扇区化天线
    class AOGSector_inH_Circle : public AntennaOrientGain {
    private:
        /// 天线的水平向3dB带宽
    ...
    public:
        ...
        AOGSector_inH_Circle(double _d3DBBeamWidthHDeg, double _d3DBBeamWidthVDeg, double _dHBackLossDB, double _dVBackLossDB, double _dABackLossDB, double _dDownTiltDeg);
        /// destructor of class AOGSector
        ~AOGSector_inH_Circle() override = default;
    };
}