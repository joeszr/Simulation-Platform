///@file SimpleMMSE_UL.cpp
///@brief  SimpleMMSE检测算法的实现
///@author wangfei

#include "Detector_UL.h"
#include "SimpleMMSE_UL.h"

mat SimpleMMSE_UL::CalculateSINR(const cmat& _mS, const cmat& _mH, const cmat& _mP,
...
//上行添加_begin
mat SimpleMMSE_UL::CalculateIoT(const cmat& _mS, const cmat& _mH, const cmat& _mP,
        const vector<cmat>& _vSIS, const vector<cmat>& _vSIH,
        const vector<cmat>& _vSIP, const vector<cmat>& _vWIS,
        const vector<double>& _vWIL) {
    assert(false);
...
itpp::cmat SimpleMMSE_UL::CalculateDetecMatrix(const cmat& _mS, const cmat& _mH, const cmat& _mP,
        const vector<cmat>& _vSIS, const vector<cmat>& _vSIH,
        const vector<cmat>& _vSIP, const vector<cmat>& _vWIS,
        const vector<double>& _vWIL) {
    assert(false);
