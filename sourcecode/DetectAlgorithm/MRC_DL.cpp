...
itpp::mat MRC_DL::CalculateSINR(const cmat& _mS, const cmat& _mH, const cmat& _mP,
    ...
    double dNoisePowerMw =  Parameters::Instance().MSS.FirstBand.DL.DSCNoisePowerMw; //处理热噪声
