...
/*
 * File:   RISUrbanMacro.h
 * Author: oumali
 *
 * Created on 2023年7月28日, 下午3:00
 */
...
namespace cm{
    class RISUrbanMacro : public Scenario{
    public:
        ...
        ////////////////////////////////////////BCS调用////////////////////////////////////////////////////
        virtual bool DecideLOS(double _dDisM_2D, bool _bIsMacro2UE ,double height);
